      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow p-6">
        ...
        <form onSubmit={onSubmit} className="mt-4 space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2 pr-12 focus:outline-none focus:ring-2 focus:ring-indigo-500"
              />
              <button
                type="button"
          ...
          <div className="flex items-center justify-between">
            ...
            <Link href="/forgot" className="text-sm text-indigo-600 hover:underline">Glömt lösenord?</Link>
          </div>
          ...
          <p className="text-sm text-gray-600 text-center">
            Ny här?{" "}
            <Link href="/signup" className="text-indigo-600 hover:underline">Skapa konto</Link>
          </p>
        </form>
      </div>
    </main>
