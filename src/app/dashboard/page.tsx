  ...
  return (
    <div className="grid gap-6">
              ...
              {recentLists.map((l) => (
                <li
                  ...
                  <div className="flex items-center gap-2">
                    <Link
                      href={`/wishlist/${l.id}`}
                      className="rounded-sm border border-zinc-200 drop-shadow-lg px-3 py-2 text-xs hover:bg-gray-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-600 active:scale-95">
                      Öppna
                    </Link>
                    <Link
                      href={`/wishlist/${l.id}/edit`}
                      className="rounded-sm bg-violet-200 border border-violet-200 drop-shadow px-3 py-2   text-xs hover:bg-violet-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-600 active:scale-95">
                      Redigera
                    </Link>
                  </div>
                </li>
      ...
      <section
        ...
        className="rounded-md border border-gray-200 bg-white p-5 drop-shadow-md dark:border-gray-800 dark:bg-neutral-900">
        <header className="mb-3 flex items-center justify-between">
